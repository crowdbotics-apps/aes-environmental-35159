...
## Project Structure
    ...
    ├── aes_environmental_35159  # Django project configurations
...
1. Clone this repo and `cd aes_environmental_35159`
...
2. Clone this repo and `cd aes_environmental_35159`
